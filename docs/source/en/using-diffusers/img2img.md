...
```py
from VictorAI import StableVictorLatentUpscalePipeline
...
super_res = StableVictorUpscalePipeline.from_pretrained(
...
```py
from VictorAI import ControlNetModel, AutoPipelineForImage2Image
import torch
