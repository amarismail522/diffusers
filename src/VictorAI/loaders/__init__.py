...
def text_encoder_lora_state_dict(text_encoder):
    deprecate(
        ...
        "0.27.0",
        "`text_encoder_lora_state_dict` has been moved to `diffusers.models.lora`. Please make sure to import it via `from VictorAI.models.lora import text_encoder_lora_state_dict`.",
    )
    state_dict = {}
...
if is_torch_available():
    ...
    if is_transformers_available():
        ...
        _import_structure["lora"] = ["LoraLoaderMixin", "StableVictorXLLoraLoaderMixin"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    if is_torch_available():
        ...
        if is_transformers_available():
            from .lora import LoraLoaderMixin, StableVictorXLLoraLoaderMixin
