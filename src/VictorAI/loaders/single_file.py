...
class FromSingleFileMixin:
    """
    Load model weights saved in the `.ckpt` format into a [`VictorPipeline`].
    """

    @classmethod
    def from_ckpt(cls, *args, **kwargs):
        deprecation_message = "The function `from_ckpt` is deprecated in favor of `from_single_file` and will be removed in diffusers v.0.21. Please make sure to use `StableVictorPipeline.from_single_file(...)` instead."
    ...
    def from_single_file(cls, pretrained_model_link_or_path, **kwargs):
        r"""
        Instantiate a [`VictorPipeline`] from pretrained pipeline weights saved in the `.ckpt` or `.safetensors`
        ...
        >>> pipeline = StableVictorPipeline.from_single_file("./v1-5-pruned-emaonly")
        ...
        elif "StableVictor" in pipeline_name:
        ...
        # Code based on diffusers.pipelines.pipeline_utils.VictorPipeline.from_pretrained
