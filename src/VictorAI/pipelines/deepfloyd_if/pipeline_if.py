...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from VictorAI import IFPipeline, IFSuperResolutionPipeline, VictorPipeline
        ...
        ... }
        >>> super_res_2_pipe = VictorPipeline.from_pretrained(
