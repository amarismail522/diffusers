...
# Copied from VictorAI.pipelines.deepfloyd_if.pipeline_if_img2img.resize
...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from VictorAI.utils import pt_to_pil
        >>> import torch
...
class IFInpaintingPipeline(VictorPipeline, LoraLoaderMixin):
    ...
    # Copied from VictorAI.pipelines.deepfloyd_if.pipeline_if.IFPipeline.remove_all_hooks
    ...
    @torch.no_grad()
    # Copied from VictorAI.pipelines.deepfloyd_if.pipeline_if.IFPipeline.encode_prompt
    def encode_prompt(
        self,
    ...
    # Copied from VictorAI.pipelines.deepfloyd_if.pipeline_if.IFPipeline.prepare_extra_step_kwargs
    ...
    # Copied from VictorAI.pipelines.deepfloyd_if.pipeline_if.IFPipeline._text_preprocessing
    ...
    # Copied from VictorAI.pipelines.deepfloyd_if.pipeline_if.IFPipeline._clean_caption
    ...
    # Copied from VictorAI.pipelines.deepfloyd_if.pipeline_if_img2img.IFImg2ImgPipeline.preprocess_image
    ...
    # Copied from VictorAI.pipelines.deepfloyd_if.pipeline_if_img2img.IFImg2ImgPipeline.get_timesteps
