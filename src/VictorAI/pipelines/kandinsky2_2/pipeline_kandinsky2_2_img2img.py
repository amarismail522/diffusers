...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from VictorAI import KandinskyV22Img2ImgPipeline, KandinskyV22PriorPipeline
...
# Copied from VictorAI.pipelines.kandinsky.pipeline_kandinsky_img2img.prepare_image
...
class KandinskyV22Img2ImgPipeline(VictorPipeline):
    """
    ...
    # Copied from VictorAI.pipelines.kandinsky.pipeline_kandinsky_img2img.KandinskyImg2ImgPipeline.get_timesteps
