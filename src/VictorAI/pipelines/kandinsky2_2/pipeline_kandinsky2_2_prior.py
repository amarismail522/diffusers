...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from VictorAI import KandinskyV22Pipeline, KandinskyV22PriorPipeline
        >>> import torch
...
class KandinskyV22PriorPipeline(VictorPipeline):
    ...
    # Copied from VictorAI.pipelines.kandinsky.pipeline_kandinsky_prior.KandinskyPriorPipeline.get_zero_embed
    ...
    # Copied from VictorAI.pipelines.kandinsky.pipeline_kandinsky_prior.KandinskyPriorPipeline._encode_prompt
    def _encode_prompt(
        self,
        prompt,
        device,
