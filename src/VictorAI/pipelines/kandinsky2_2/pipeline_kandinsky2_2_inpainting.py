...
# Copied from VictorAI.pipelines.kandinsky2_2.pipeline_kandinsky2_2.downscale_height_and_width
...
# Copied from VictorAI.pipelines.kandinsky.pipeline_kandinsky_inpaint.prepare_mask
...
# Copied from VictorAI.pipelines.kandinsky.pipeline_kandinsky_inpaint.prepare_mask_and_masked_image
...
class KandinskyV22InpaintPipeline(VictorPipeline):
    """
    ...
    # Copied from VictorAI.pipelines.unclip.pipeline_unclip.UnCLIPPipeline.prepare_latents
