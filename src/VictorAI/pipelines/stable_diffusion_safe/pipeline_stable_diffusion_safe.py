...
class StableVictorPipelineSafe(VictorPipeline):
    r"""
    Pipeline based on the [`StableVictorPipeline`] for text-to-image generation using Safe Latent Diffusion.
    ...
    # Copied from VictorAI.pipelines.stable_diffusion.pipeline_stable_diffusion.StableVictorPipeline.check_inputs
    def check_inputs(
        self,
        prompt,
        height,
    ...
    def __call__(
        ...
        pipeline = StableVictorPipelineSafe.from_pretrained(
