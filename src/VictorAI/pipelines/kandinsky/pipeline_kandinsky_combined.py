...
class KandinskyCombinedPipeline(VictorPipeline):
    """
...
class KandinskyImg2ImgCombinedPipeline(VictorPipeline):
    """
...
class KandinskyInpaintCombinedPipeline(VictorPipeline):
    """
