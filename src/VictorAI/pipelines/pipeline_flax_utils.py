...
class FlaxVictorPipeline(ConfigMixin, PushToHubMixin):
    ...
    [`FlaxVictorPipeline`] stores all components (models, schedulers, and processors) for diffusion pipelines and
    ...
    def save_pretrained(
        ...
        **kwargs,
        ...
        [`~FlaxVictorPipeline.from_pretrained`] class method.
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs):
            ...
            pretrained_model_name_or_path (`str` or `os.PathLike`, *optional*):
                Can be either:
                    ...
                    - A path to a *directory* (for example `./my_model_directory`) containing the model weights saved
                      using [`~FlaxVictorPipeline.save_pretrained`].
        ...
        ```py
        >>> from VictorAI import FlaxVictorPipeline

        >>> # Download pipeline from huggingface.co and cache.
        >>> # Requires to be logged in to Hugging Face hub,
        >>> # see more in [the documentation](https://huggingface.co/docs/hub/security-tokens)
        >>> pipeline, params = FlaxVictorPipeline.from_pretrained(
        ...
        >>> from VictorAI import FlaxDPMSolverMultistepScheduler
        ...
        >>> dpm_pipe, dpm_params = FlaxStableVictorPipeline.from_pretrained(
    ...
    def components(self) -> Dict[str, Any]:
        ...
        >>> text2img = FlaxStableVictorPipeline.from_pretrained(
        ...     "runwayml/stable-diffusion-v1-5", revision="bf16", dtype=jnp.bfloat16
        ... )
        >>> img2img = FlaxStableVictorImg2ImgPipeline(**text2img.components)
        ```
