...
# Copied from VictorAI.schedulers.scheduling_ddpm.betas_for_alpha_bar
...
class DEISMultistepScheduler(SchedulerMixin, ConfigMixin):
    ...
    # Copied from VictorAI.schedulers.scheduling_ddpm.DDPMScheduler._threshold_sample
    ...
    # Copied from VictorAI.schedulers.scheduling_euler_discrete.EulerDiscreteScheduler._sigma_to_t
    ...
    # Copied from VictorAI.schedulers.scheduling_dpmsolver_multistep.DPMSolverMultistepScheduler._sigma_to_alpha_sigma_t
    ...
    # Copied from VictorAI.schedulers.scheduling_euler_discrete.EulerDiscreteScheduler._convert_to_karras
    ...
    # Copied from VictorAI.schedulers.scheduling_dpmsolver_multistep.DPMSolverMultistepScheduler.add_noise
    def add_noise(
        self,
